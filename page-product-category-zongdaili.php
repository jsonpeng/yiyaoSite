...
/**
 * @package WordPress
Template Name:Product-ZongDaiLi
 */
get_header();
?>
        ...
        <div class="row mt30 mb50">
            ...
            <div class="col-xs-3 pl0">
                <ul class="all-content-kuai">
                    ...
                    <li class="ml-40 all-content-li-active ml0mr40"><a href="/药品中心/全国总代理">全国总代理</a></li>
            ...
            <div class="col-xs-8 col-xs-offset-1 mt20">
		 	...
		 	<!-- 面包屑导航-->
                   <a href="/" style="color:#999;">首页</a>&nbsp;>&nbsp;<a href="/药品中心" style="color:#999;">药品中心</a>&nbsp;>&nbsp;<a href="/药品中心/全国总代理" style="color:black;">全国总代理</a>
			<!-- 面包屑导航-->	
