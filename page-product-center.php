        ...
        <div class="row mt30 mb50">
            ...
            <div class="col-xs-3 pl0">
                <ul class="all-content-kuai">
				    ...
				    <li class="ml-40  all-content-li-active ml0mr40"><a href="/药品中心">全部产品</a></li>
...
query_posts('post_type=product&post_status=publish&showposts=' . $limit=9 . '&paged=' . $paged);
